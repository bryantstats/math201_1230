...
---
title: "One-sample and Two-sample Test"
output:
  html_document:
    toc: yes
    toc_float: yes
...
**Step 2**: Choose a variable/quantity about Bryant class of 26 of your interested. For example: The number of hours a freshman studied per week. 
...
- [Sample Poster](sample_poster.pptx)

**Step 9**. Submit the follows to Canvas.
